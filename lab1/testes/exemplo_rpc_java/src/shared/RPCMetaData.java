...
/**
 * Estrutura para representar os dados que indicarão
 * a função remota e, ao mesmo tempo, os seus valores
 * de entrada (parâmetros). Assim, espera-se evitar
 * o envio de múltiplas mensagens do client onde cada
 * um seria um argumento. De forma que, agora, o server
 * verificará apenas se a RP (Remote Procedure) com
 * o `id` (máximo 0x7FFF) passado existe. O servidor
 * apenas lerá um objeto desta classe, enquanto o
 * processo cliente irá construí-lo.
 */
public class RPCMetaData implements Serializable {
    private static final long serialVersionUID = 1L;

    // Identificadores dos procedimentos remotos disponíveis:
    public static final short ID_RP_SOMAR = 0x1;
    public static final short ID_RP_MULTIPLICAR= 0x2;

    // Identificador do procedimento remoto requisitado
    private short id;

    // Lista de argumentos passados pelo processo cliente
